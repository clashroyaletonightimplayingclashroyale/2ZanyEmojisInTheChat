...
public class Node implements Comparable<Node> {
    ...
    public void setState(Node previous) {
        _previous = previous;
        _distanceSoFar = previous == null ? Double.MAX_VALUE : previous._distanceSoFar + _point.distance(previous._point);
    }

    public void setDistanceSoFar(double newDistance){
        _distanceSoFar = newDistance;
    }
   ...
   @Override
    ...
    public int compareTo(Node other) {
        // return (int)(this._cost-other._cost);
